...
# 4. Realice el ejercicio anterior poniendo a prueba el rango altitudinal que abarcan como un proxy para la heterogeneidad ambiental en una regresión lineal simple. Además, realice diferentes pruebas de anova para las variables ambientales y rango altitudinal para mirar diferencias de las variables en cada cordillera. Utilice la prueba de Tukey post-hoc utilizando la función TukeyHSD() para evaluar si hay diferencias significativas entre las medias. Reporte los resultados de manera escrita y gráfica y discuta sobre las diferencias en las diferentes cordilleras. 
